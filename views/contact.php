                    ...
                    <div class="tekst row d-flex justify-content-center tekstContact">
                        ...
                        <div class="col-lg-8 col-11 text-center">
                            ...
                            <form action="" method="POST" class="contactForma mx-auto">
                    
                                <div class="form-group row">
                                    <div class="col-lg-12 col-12 mb-0 mb-md-0 mx-auto">
                                        <i class="fas fa-user-alt"></i>
                                        <input type="text" class="" name="usernameLog" id="usernameLog" placeholder="Name" onfocus="this.placeholder=''" onblur="this.placeholder='Name'"/>
                                        <p class="errorMsgLogin"></p>

                                        
                                    </div>
                                    <div class="col-lg-12 col-12 mx-auto">
                                        <i class="fas fa-font"></i>
                                        <input type="text" class="" name="usernameLog" id="usernameLog" placeholder="Subject" onfocus="this.placeholder=''" onblur="this.placeholder='Subject'"/>
                                        <p class="errorMsgLogin"></p>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-12 mt-4 mx-auto">
                                        ...
                                        <textarea id="exampleFormControlTextarea1"  placeholder="Message" onfocus="this.placeholder=''" onblur="this.placeholder='Message'"></textarea>
                                    </div>
                                    <div class="col-lg-12 col-10 mb-3 mb-md-0 mx-auto">
                                        <input type="submit" class="btn-danger btnSubmit mt-4" name="btnLogin" value="Send Message"/>
